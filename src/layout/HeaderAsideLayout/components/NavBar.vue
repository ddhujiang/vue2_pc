      ...
      <div class="user-profile-content">
        ...
        <el-dropdown>
          <div class="user-profile-body">
            ...
            <span class="user-name">{{userData.info.name}}</span>
          </div>
          <el-dropdown-menu class="user-dropdown" slot="dropdown">
            ...
            <el-dropdown-item>
              <span @click="logOff" style="display:block;">退出</span>
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
...
export default {
    ...
    computed: {
        //赋值
        ...mapGetters("admin", { userData: "user/getData" })
    }
};
</script>

<style>
.main-container .el-menu--horizontal {
